import nextButton from "./next-button.twig";
...
export default {
  title: "Design System/Atoms/Next button",
};

const Template = ({ icon, next_url, next_title, button_label }) =>
  nextButton({
    icon,
    next_url,
    next_title,
...
export const NextButtonHTML = Template.bind({});
NextButtonHTML.args = {
  icon: icon_markup,
  next_url: "#",
